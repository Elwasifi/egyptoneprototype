...
export const metadata: Metadata = { title: "Transactions", description: "Settlement records flowing through your integration." };
...
export default async function Page({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <PortalShell portal={"Strategic Partner"} title={"Transactions"} subtitle={"Settlement records flowing through your integration."} nav={PARTNER_NAV} active={"/partner/transactions"} accent={"royal"} roleNote={""}>
      <div className="grid gap-6">
        <EmptyState title="No transactions yet" body="No payment adapter is live." />
      </div>
    </PortalShell>
  );
}
